...
public class AllOperations {
	...
	public boolean departmentInput() {
		scanner.nextLine();
	...
	public boolean leaveInput() {
		...
		Employee employee = new Employee();
		Leave leave = new Leave(leaveId, startDate, endDate, reason,  record_status,employee);
		return leaveservice.saveLeave(leave);
	}
	
	public Attendence attendenceInput() {
		scanner.nextLine();
