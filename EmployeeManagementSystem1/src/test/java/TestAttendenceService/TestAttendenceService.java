...
public class TestAttendenceService {
   ...
   void testsaveAttendence() {
		...
		Attendence testAttendence1 = new Attendence(52, LocalDate.parse("2024-03-14"), "9:00", "6:00", 'A', employee);
		assertTrue(attendenceService.saveAttendence(testAttendence1));

		Attendence testAttendence2 = new Attendence(53, LocalDate.parse("2024-03-14"), "9:00", "6:00", 'A', employee);
	...
	//void testUpdateAttendence() {
		//Attendence attendences = new Attendence(4, LocalDate.parse("2024-03-16"), "9:00", "6:00", 'A', employee);
