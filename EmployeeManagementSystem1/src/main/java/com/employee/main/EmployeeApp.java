...
public class EmployeeApp {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Task task = new Task(1, "Implement Feature X", LocalDate.parse("2024-02-01"), LocalDate.parse("2024-02-10"), 'A', employee);
			session.save(task);
			
			Project project = new Project(22685, 50000.00, "In Progress", 'A', employee);
			session.save(project);
			
			Leave leave = new Leave(20, LocalDate.parse("2024-01-12"), LocalDate.parse("2024-01-16"), "Festival", 'A',employee);
			session.save(leave);
